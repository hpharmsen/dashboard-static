...
from settings import dependent_color, EFFECTIVITY_RED, EFFECTIVITY_GREEN, get_output_folder, CORRECTIONS_RED, \
    CORRECTIONS_GREEN
...
def kpi_grid(weeks = 4, reverse=False):
    ...
    return KPIgrid(week_numbers, data, verbose=False, effectivity_coloring=effectivity_coloring, corrections_coloring=corrections_coloring)
