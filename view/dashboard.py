...
def klanten_block():
    # Risico
    klanten = VBlock([TextBlock('Klanten', midsize),
...
def pijplijn_block():
    pijplijn = VBlock([
        ...
        TextBlock(werk_in_pijplijn(), headersize, format='K',
...
def rocks_block():
    ...
    return VBlock([
        TextBlock('Q1 Rocks', headersize),
        rocks_grid
    ])


def debiteuren_block():
    return VBlock( [TextBlock('Debiteuren', midsize),
                    StackedBarChart(
                        240,
                        470,
                        '',
...
def render_dashboard():
    ...
    page = Page([HBlock([
        ...
        VBlock([resultaat_block(),
                pijplijn_block(),
                organisatie_block()]),

        VBlock([productiviteit_block(),
                billable_chart(),
                omzet_chart(),
                omzet_prognose_chart()]),
